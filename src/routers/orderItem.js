...
const { getOrderItemValidator,createOrderItemValidator,updateOrderItemValidator,deleteOrderItemValidator } = require('../validators/orderItems.js');
...
orderItemRouter.delete('/order/:orderId',deleteOrderItemValidator(),validate,verifyJWT, orderItemController.deletAllOrderItemOfAOrder);
